...
> However, if you want to suggest features, options, or contribute, check the `Contributing` tab/file.
> 
...
## Licence
This project, which is DTSCM, is licenced under the MIT License. See [here](https://github.com/DexTheSillyCat/DTSCM/blob/main/LICENSE "Licence") for more info.
